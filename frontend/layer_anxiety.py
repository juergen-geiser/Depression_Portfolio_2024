...
class Ui_layer_3(object):
    def setupUi(self, layer_3):
        """
        Set up the user interface for the 'layer_3' window.

        Parameters:
        layer_3 (QtWidgets.QWidget): The widget that acts as the parent for all other UI elements.
        """
        layer_3.setObjectName("layer_3")
        layer_3.resize(792, 572)
        
        # Set the background color with a gradient
        layer_3.setStyleSheet("QWidget#layer_3{\n"
        ...
        self.layoutWidget = QtWidgets.QWidget(layer_3)
        ...
        self.create_comboBox_with_label("Depressiveness diagnosis", ["no", "yes"], 2, 0)
        ...
        self.create_comboBox_with_label("Height in cm", [str(i) for i in range(140, 221)], 4, 2)
        self.create_comboBox_with_label("Weight in kg", [str(i) for i in range(40, 251)], 5, 2)
        ...
        self.headlineDepressiveness = QtWidgets.QLabel(layer_3)
        ...
        self.frame = QtWidgets.QFrame(layer_3)
        ...
        self.retranslateUi(layer_3)
        QtCore.QMetaObject.connectSlotsByName(layer_3)
    ...
    def retranslateUi(self, layer_3):
        ...
        self.ButtonToWelcome.setText(_translate("layer_3", "return to Welcome"))
